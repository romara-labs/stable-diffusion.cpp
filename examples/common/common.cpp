...
ArgOptions SDContextParams::get_options() {
    ...
    options.string_options = {
        ...
        {"",
         "--cliproj",
         "path to a MiniMax-H3 ClipProj projection matrix (.safetensors)",
         0,
         &cliproj_path},
        {"",
         "--qwen2vl",
...
sd_ctx_params_t SDContextParams::to_sd_ctx_params_t(bool taesd_preview) {
    ...
    sd_ctx_params.cliproj_path                    = cliproj_path.c_str();
...
std::string build_sdcpp_image_metadata_json(const SDContextParams& ctx_params,
    ...
    set_json_basename_if_not_empty(models, "cliproj", ctx_params.cliproj_path);
